...
<ArgTableRow arg="dst-address" typ="地址 (标志=6/)"></ArgTableRow>
<ArgTableRow arg="routing-table" typ="枚举"></ArgTableRow>
<ArgTableRow arg="pref-src" typ="地址 (标志=6)" unset="1"></ArgTableRow>
<ArgTableRow arg="gateway" typ="地址 (标志=6ivSL)" unset="1"></ArgTableRow>
...
<ArgTableRow arg="immediate-gw" typ="多值 { 地址 (标志=6i)
 }"></ArgTableRow>
</ArgTable>