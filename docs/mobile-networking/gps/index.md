...
> This page documents GPS configuration and monitoring in MikroTik RouterOS, covering properties like channel selection, coordinate formats, GPS initialization strings, and monitoring commands with parameters such as date-and-time, latitude/longitude, altitude, satellites, and data age.
...
We have also created an in-depth article about live GPS tracking, using scripting and a web server: [GPS-tracking](./gps-tracking-using-http-post.md).
