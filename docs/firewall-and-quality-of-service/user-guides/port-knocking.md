...
:::warning
Blacklist rules from this section are added **disabled=yes** in order to avoid locking out the user. Enable the filter rules, once the alternative access is available or use `<Safe Mode>`
:::
...
Layer7 rules are very resource-intensive. Do not use them unless you know what you are doing.
:::

<details>
<summary>Click to open code block</summary>
...
:::warning
For an additional security layer see the Bruteforce prevention article: [Bruteforce prevention](./bruteforce-prevention.md)
:::
