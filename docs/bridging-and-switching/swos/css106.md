...
![Swos login css106](/docs/bridging-and-switching/swos/img/css106-01.webp)
...
![Swos system1](/docs/bridging-and-switching/swos/img/css106-02.webp)
...
![Swos password css106](/docs/bridging-and-switching/swos/img/css106-03.webp)
...
![Swos link css106](/docs/bridging-and-switching/swos/img/css106-04.webp)
...
![740px Swospoe2](/docs/bridging-and-switching/swos/img/css106-05.webp)
...
![Swos sfp css106](/docs/bridging-and-switching/swos/img/css106-06.webp)
...
![740px Swos forwarding2](/docs/bridging-and-switching/swos/img/css106-07.webp)
...
![Swos RSTP css106](/docs/bridging-and-switching/swos/img/css106-08.webp)
...
![Swos stats css106](/docs/bridging-and-switching/swos/img/css106-09.webp)

![Swos error css106](/docs/bridging-and-switching/swos/img/css106-10.webp)
...
![740px Swos vlan2](/docs/bridging-and-switching/swos/img/css106-11.webp)
...
![Swos vlan css106](/docs/bridging-and-switching/swos/img/css106-12.webp)
...
![Access ports small](/docs/bridging-and-switching/swos/img/css106-13.webp)

1. In the System menu enable independent VLAN learning (IVL).

![Css106 ivl](/docs/bridging-and-switching/swos/img/css106-14.webp)
...
![Css access trunk vlans](/docs/bridging-and-switching/swos/img/css106-15.webp)
...
![Css106 access vlan](/docs/bridging-and-switching/swos/img/css106-16.webp)

> **Note:** CSS106 devices running SwOS version 2.12 can filter RSTP BPDU packets when enabling VLAN filtering on ports (VLAN Mode **enabled** or **strict**). With SwOS version 2.13, it is recommended to set VLAN Receive to **any** on trunk ports.

#### Trunk and Hybrid Ports

![Hybrid ports small](/docs/bridging-and-switching/swos/img/css106-17.webp)

1. In the System menu enable independent VLAN learning (IVL).

![Css106 ivl 1](/docs/bridging-and-switching/swos/img/css106-18.webp)

1. In the VLANs menu add VLAN entries, specify port membership, and enable IVL. The default "leave as is" port setting can be used; the tagging and untagging behavior can be changed with the "Default VLAN ID" setting, see the next step.

![Css hybrid vlan](/docs/bridging-and-switching/swos/img/css106-19.webp)
...
![Css hybrid vlans](/docs/bridging-and-switching/swos/img/css106-20.webp)
...
![Css106 system vlan](/docs/bridging-and-switching/swos/img/css106-21.webp)
...
![Swos hosts css106](/docs/bridging-and-switching/swos/img/css106-22.webp)
...
![740px Swos static2](/docs/bridging-and-switching/swos/img/css106-23.webp)
...
![Swos igmp2 css106](/docs/bridging-and-switching/swos/img/css106-24.webp)

Available IGMP snooping data can be found under the IGMP Group tab.

![Swos igmp css106](/docs/bridging-and-switching/swos/img/css106-25.webp)

Possibility to enable or disable IGMP Snooping for a specific VLAN ID.

![Swos igmp3 css106](/docs/bridging-and-switching/swos/img/css106-26.webp)
...
![Swos snmp2](/docs/bridging-and-switching/swos/img/css106-27.webp)
...
![740px Swos acl2](/docs/bridging-and-switching/swos/img/css106-28.webp)
