...
Specifies the [ICMP error](https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml#icmpv6-parameters-codes-2) to be sent back if the packet is rejected. Applicable if `action=reject`.
