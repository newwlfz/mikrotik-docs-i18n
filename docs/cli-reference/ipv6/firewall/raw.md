...
<ArgTableRow arg="bytes" typ="num">Total amount of bytes matched by the rule.</ArgTableRow>
<ArgTableRow arg="packets" typ="num">Total amount of packets matched by the rule.</ArgTableRow>
</ArgTable>
