...
<ArgTableRow arg="active-listener" typ="iface_enum { none:nv::BADID }"></ArgTableRow>
...
<ArgTableRow arg="type" typ="enum (TLKA | TLKF | LSTN-I | LSTN-AF | LSTN-R | LSTN-RF)"></ArgTableRow>
<ArgTableRow arg="registrar-state" typ="enum (IN | LV | MT)"></ArgTableRow>
<ArgTableRow arg="applicant-state" typ="enum (Very anxious Observer | Very anxious Passive | Very anxious New | Anxious New | Anxious Active | Quiet Active | Leaving Active | Anxious Observer | Quiet Observer | Anxious Passive | Quiet Passive | Leaving Observer)"></ArgTableRow>
<ArgTableRow arg="last-event" typ="enum (New | JoinIn | In | JoinEmpty | Empty | Leave)"></ArgTableRow>
<ArgTableRow arg="stream-id" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="dst-mac" typ="macAddr"></ArgTableRow>
<ArgTableRow arg="vid" typ="num"></ArgTableRow>
<ArgTableRow arg="max-frame-size" typ="num"></ArgTableRow>
...
<ArgTable c1="Argument" c2="Type" c3="Description">
<ArgTableRow arg="bridge" typ="iface_enum" mandatory="1"></ArgTableRow>
<ArgTableRow arg="id" typ="num" mandatory="1"></ArgTableRow>
<ArgTableRow arg="priority" typ="num"></ArgTableRow>
...
<ArgTableRow arg="priority" typ="num"></ArgTableRow>
<ArgTableRow arg="vlan-id" typ="num"></ArgTableRow>
<ArgTableRow arg="core-ports" typ="multi { array-id, iface_enum
 }"></ArgTableRow>
<ArgTableRow arg="boundary-ports" typ="multi { array-id, iface_enum
 }"></ArgTableRow>
</ArgTable>
...
<ArgTableRow arg="bridge" typ="iface_enum" mandatory="1"></ArgTableRow>
<ArgTableRow arg="priority" typ="num"></ArgTableRow>
<ArgTableRow arg="vlan-mapping" typ="multi { , , range [1 .. 4094]
 }" mandatory="1"></ArgTableRow>
</ArgTable>
...
<ArgTableRow arg="dynamic" typ="switch"></ArgTableRow>
<ArgTableRow arg="chain" typ="enum" mandatory="1"></ArgTableRow>
<ArgTableRow arg="action" typ="enum (accept | passthrough | drop | jump | return | log | mark-packet | set-priority | src-nat | dst-nat | redirect | arp-reply)"></ArgTableRow>
<ArgTableRow arg="jump-target" typ="enum ()"></ArgTableRow>
<ArgTableRow arg="new-packet-mark" typ="enum ()"></ArgTableRow>
...
<ArgTableRow arg="edge" typ="enum (auto | yes | no | yes-discover | no-discover)"></ArgTableRow>
<ArgTableRow arg="point-to-point" typ="enum (auto | yes | no)"></ArgTableRow>
<ArgTableRow arg="learn" typ="enum (auto | yes | no)"></ArgTableRow>
...
<ArgTableRow arg="port-id" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="role" typ="enum (disabled-port | root-port | designated-port | alternate-port | backup-port)"></ArgTableRow>
...
<ArgTableRow arg="designated-bridge-id" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="designated-cost" typ="num"></ArgTableRow>
<ArgTableRow arg="designated-port-id" typ="composite { ,  }"></ArgTableRow>
...
<ArgTableRow arg="tx-rx-bpdu" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="discard-transitions" typ="num"></ArgTableRow>
<ArgTableRow arg="forward-transitions" typ="num"></ArgTableRow>
<ArgTableRow arg="tx-rx-tc" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="topology-changes" typ="num"></ArgTableRow>
<ArgTableRow arg="last-topology-change" typ="time"></ArgTableRow>
<ArgTableRow arg="multicast-router" typ="bool"></ArgTableRow>
<ArgTableRow arg="hw-offload-group" typ="enum"></ArgTableRow>
...
<ArgTableRow arg="identifier" typ="num"></ArgTableRow>
<ArgTableRow arg="port-id" typ="composite { ,  }"></ArgTableRow>
<ArgTableRow arg="role" typ="enum (disabled-port | root-port | designated-port | alternate-port | backup-port | master-port)"></ArgTableRow>
<ArgTableRow arg="learning" typ="bool"></ArgTableRow>
<ArgTableRow arg="forwarding" typ="bool"></ArgTableRow>
<ArgTableRow arg="internal-root-path-cost" typ="num"></ArgTableRow>
<ArgTableRow arg="designated-bridge-id" typ="composite { ,  }"></ArgTableRow>
...
<ArgTable c1="Argument" c2="Type" c3="Description">
<ArgTableRow arg="bridge" typ="iface_enum" mandatory="1"></ArgTableRow>
<ArgTableRow arg="vlan-ids" typ="multi { , , range [1 .. 4094]
 }" mandatory="1"></ArgTableRow>
<ArgTableRow arg="tagged" typ="multi { array-id, alt { iface_enum {  } {  }
, enum
 } { iface_enum {  } {  }
, enum
 }
 }"></ArgTableRow>
<ArgTableRow arg="untagged" typ="multi { array-id, alt { iface_enum {  } {  }
, enum
 } { iface_enum {  } {  }
, enum
 }
 }"></ArgTableRow>
<ArgTableRow arg="mvrp-forbidden" typ="multi { array-id, alt { iface_enum {  } {  }
, enum
 } { iface_enum {  } {  }
, enum
 }
...
<ArgTable c1="Read-only Argument" c2="Type" c3="Description">
<ArgTableRow arg="current-tagged" typ="multi { array-id, iface_enum {  } {  }
 }"></ArgTableRow>
<ArgTableRow arg="current-untagged" typ="multi { array-id, iface_enum {  } {  }
 }"></ArgTableRow>
</ArgTable>
